        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="containerCadastro">
                    ...
                    <form action="backEnd/cadastroLogin.php" class="form" method="POST">
                        
                        <div class="input-field">
                            <input id="username" name="nome" type="text" autocomplete="off" required="">
                        ...
                        <div class="input-field">
                            <input id="password" name="senha" type="password" autocomplete="off" required="">
                            <label for="username">Senha</label>
                        </div>
                        
                        <div class="btn-container d-flex justify-content-between">
                            <button class="btn">Cadastrar</button>
                            <div class="acc-text d-flex align-items-center">
                                <span>
                                    Seja Bem-Vindo! 
                                </span>
                                <span class="ms-3 mb-2" style="color : #0000ff; cursor : pointer;">
